...
const AddCitizen = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setMessage(`Citizen Adding  failed: ${response.data.message}`);
            }
        } catch (error) {
            console.error('Citizen Adding  error:', error.response ? error.response.data : error.message);
    ...
    return (
        <div style={styles.container}>
            <h2 style={styles.heading}>Add Citizen from Admin Side</h2>
